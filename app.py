...
if generate_button:
    if text_to_convert:
        ...
        try:
            if detect(text_to_convert) == 'hi':
                st.info("🇮🇳 Hindi text detected! Switching to the Hindi narrator.")
                final_voice, final_voice_name = "hi-IN-MadhurNeural", "Hindi (Madhur - Narrator)"
            ...
            if success:
                ...
                with open(output_file_path, "rb") as file:
                    ...
                    st.download_button(
                        ...
                        mime="audio/mpeg"  # This is the crucial part!
                    )
